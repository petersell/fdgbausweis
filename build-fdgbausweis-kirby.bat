...
ant -f C:/Users/A.Petersell/Dropbox/DITA-SRCME/seminarwork-fdgbausweis/build-petersell.xml -Dpubname=fdgbausweis-kirby -logger org.dita.dost.log.DITAOTBuildLogger %1